document.querySelector(".signup-btn").addEventListener("click", function(e) {
    ...
    var firstName = document.querySelectorAll(".name-row .input-field")[0].value.trim();
    var surName = document.querySelectorAll(".name-row .input-field")[1].value.trim();
    ...
    if (password.length < 8) {
        Swal.fire("Error", "Password should be at least 8 characters!", "error");
        return;
    }
